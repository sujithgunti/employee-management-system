...
$query = "UPDATE employees SET first_name= :first_name,last_name= :last_name, date_of_joining= :date_of_joining, date_of_birth= :date_of_birth,gender= :gender, phone_no= :phone_no,working_status_id= :working_status_id,designation_id= :designation_id,location_id=:location_id,gross= :gross WHERE id=:id";
...
sendResponse(false, "Updated failed");
